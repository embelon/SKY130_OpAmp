...
C {devices/code_shown.sym} -590 320 0 0 {name=sim1 only_toplevel=false value="
...
.save all @m.x1.xm6.msky130_fd_pr__pfet_01v8[vdsat,vds,gm,id]
.save all @m.x1.xm7.msky130_fd_pr__pfet_01v8[vdsat,vds,gm,id]
...
.endc
"}
C {devices/code_shown.sym} -590 220 0 0 {name=models1
only_toplevel=false
